...
public class FilePickerUtils {
    ...
    public static void openFilePicker(int REQUEST_CODE_OPEN_DOCUMENT, Activity context, DriveServiceHelper mDriveServiceHelper) {
    ...
    public static MyDbHelper openFileFromFilePicker(Uri selectedImageUri, DriveServiceHelper mDriveServiceHelper, Context context) {
        try {
            if (mDriveServiceHelper != null) {
